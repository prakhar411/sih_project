...
class Pallete {
  ...
  static const Color gradient1 = Color.fromRGBO(241, 70, 75, 1);
  static const Color gradient2 = Color.fromRGBO(243, 161, 29, 1);
  static const Color gradient3 = Color.fromRGBO(236, 101, 52, 1);
